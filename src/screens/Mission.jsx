export default function Mission() {
  return (
    <div className="flex flex-col gap-5 mt-12 md:mt-0 md:mb-40">
      ...
      <p className="text-md font-md max-w-3xl leading-7 sm:leading-10 sm:text-xl md:leading-10 md:text-2xl">
        Компания{" "}
      ...
      <p className="text-md max-w-3xl leading-7 sm:leading-10 sm:text-xl md:leading-10 md:text-2xl">
